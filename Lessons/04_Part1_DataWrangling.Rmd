...
NTL.phys.data.Tuesday90_99 <- filter(NTL.phys.data, lakename == "Tuesday Lake" )
NTL.phys.data.Tuesday90_99 <- filter(NTL.phys.data.Tuesday90_99, year4 %in% c(1990:1999))

```
Question: Why don't we filter using row numbers?

> Answer: They can change. 
...
NTL.phys.data.depth.descending.temp <- arrange(NTL.phys.data, desc(temperature_C))
