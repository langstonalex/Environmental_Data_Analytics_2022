...
LakeData <- read.csv("./Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv", stringsAsFactors = TRUE)
...
ggplot(processedLakeData, aes(x = depth, y = temperature_C, color = lakename))+
  geom_point(alpha = 0.5)+
  labs(y = "Temperature (C)", x = "Depth (M)", color = "Lake Name", title = "Temperature by Depth in July")+
  ylim(0,35)+
