...
OzoneFiles = list.files(
  path = "C:/Users/lwa8/Documents/R/ENV872/Environmental_Data_Analytics_2022/Data/Raw/Ozone_TimeSeries/", pattern = "*.csv", full.names = TRUE)
OzoneFiles
...
GaringerOzone <- mutate(
  GaringerOzone, Daily.Max.8.hour.Ozone.Concentration = zoo::na.approx(Daily.Max.8.hour.Ozone.Concentration))
```
